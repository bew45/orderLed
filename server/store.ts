...
export function getAppSettings(): AppSettings {
  ...
  return {
    ...
    paddle_device: nonEmpty(saved.paddle_device, process.env.ORDERLEDGER_PADDLE_DEVICE, "cpu"),
...
export function saveAppSettings(patch: Partial<AppSettings>) {
  ...
  const next: AppSettings = {
    ...
    paddle_device: patch.paddle_device !== undefined ? String(patch.paddle_device).trim() || "cpu" : current.paddle_device,
